...
export const TectonicMap: React.FC<TectonicMapProps> = ({ onSelectMine, onCommuneWithMine }) => {
    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="text-center max-w-3xl mx-auto mb-8">
        ...
        <h1 className="text-3xl sm:text-4xl font-serif font-bold text-stone-100 mb-2">
          The Tectonic World Map
        </h1>
        <p className="text-sm sm:text-base text-stone-400 font-serif leading-relaxed">
          In antique cartography, the Earth's crust is not dead rock, but a living tapestry of
          personified titanesses, water-bearing nymphs, and mineral sovereigns whose anatomical
          contours shape our greatest excavations.
        </p>
      </div>
      ...
      <div className="bg-stone-900/60 border border-stone-800/80 rounded-2xl p-4 mb-6 backdrop-blur-md flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="relative flex-1 min-w-[240px]">
          ...
          <input
            ...
            placeholder="Search by mine, mineral, deity, country..."
        ...
        <div className="lg:col-span-7 bg-stone-950/90 border border-amber-950/70 rounded-3xl p-4 sm:p-6 shadow-2xl relative overflow-hidden flex flex-col justify-between">
          ...
          <div className="flex items-center justify-between z-10 mb-3 text-xs font-serif text-stone-400">
            <span className="text-amber-400 font-bold uppercase tracking-widest text-[10px]">
              Planetary Geodesic Projection · 20 World Seams
            </span>
            <span className="font-mono text-[11px] text-stone-400">
              Showing {filteredMines.length} Mines
            </span>
          </div>
            ...
            {filteredMines.map((mine) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Pin Node */}
                  <div
                    className={`w-5 h-5 rounded-full border flex items-center justify-center transition-transform duration-200 ${
                      isSelected
          ...
          {activeCartographyMine ? (
            <div className="bg-stone-900/60 border border-stone-800/80 rounded-3xl p-5 shadow-2xl flex flex-col justify-between">
              ...
              <div className="mt-4 flex items-center gap-3 pt-3 border-t border-stone-800">
                ...
                >
                  <Eye className="w-3.5 h-3.5" /> Full Lore & Stratigraphy
                </button>
                <button
            ...
            <div className="bg-stone-900/40 border border-stone-800/80 rounded-3xl p-12 text-center flex flex-col items-center justify-center h-full">
              <Compass className="w-12 h-12 text-stone-600 mb-3" />
              <p className="text-sm font-serif text-stone-400">
                Click any mine aperture on the tectonic map to reveal its personified feminine
                cartography and mineral spirit.
              </p>
            </div>
          )}
        </div>
