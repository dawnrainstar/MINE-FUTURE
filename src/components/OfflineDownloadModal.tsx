        ...
        >
          ...
          <div className="flex items-center justify-between pb-4 border-b border-stone-800 relative z-10">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-2xl bg-amber-500/20 border border-amber-500/40 flex items-center justify-center text-amber-400 shadow-[0_0_20px_rgba(245,158,11,0.25)] shrink-0">
                <Download className="w-6 h-6" />
              </div>
              <div>
                <div className="flex items-center gap-2">
                  <span className="text-xs font-mono uppercase tracking-wider text-amber-400 bg-amber-950/80 border border-amber-500/40 px-2.5 py-0.5 rounded-full font-semibold">
                    Offline & Download Hub
                  </span>
                  <span
                    className={`text-xs font-mono flex items-center gap-1.5 px-2.5 py-0.5 rounded-full font-semibold ${
                      isOnline
                  ...
                  >
                    {isOnline ? (
                      ...
                      <>
                        <WifiOff className="w-3.5 h-3.5 text-rose-400" /> Offline Mode Active
                      </>
                    )}
                  </span>
                </div>
            ...
            <button
              onClick={onClose}
              className="p-2.5 rounded-xl bg-stone-950 border border-stone-800 text-stone-400 hover:text-white transition-colors"
            >
              <X className="w-6 h-6" />
            </button>
          </div>
          ...
          <div className="flex-1 overflow-y-auto py-6 space-y-6 relative z-10 pr-1">
            {/* Status Card */}
            <div className="bg-stone-950/90 border border-stone-800 rounded-2xl p-5 sm:p-6 space-y-3">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2.5">
                  <Database className="w-5 h-5 text-amber-400" />
                  <h4 className="text-sm font-serif uppercase tracking-wider text-amber-300 font-bold">
                    Zero-Latency Chthonic Engine
                  </h4>
                </div>
                <span className="text-xs font-mono font-semibold text-emerald-400 px-2.5 py-0.5 rounded-full bg-emerald-950/60 border border-emerald-500/30">
                  100% Offline-Capable
                </span>
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="bg-stone-950/80 border border-amber-500/40 rounded-2xl p-5 sm:p-6 flex flex-col justify-between space-y-4">
                <div className="space-y-2.5">
                  <div className="w-10 h-10 rounded-xl bg-amber-500/20 border border-amber-500/40 flex items-center justify-center text-amber-400 mb-1">
                ...
                <button
                  ...
                  className="w-full py-3.5 px-4 rounded-xl bg-amber-500 hover:bg-amber-400 text-stone-950 font-serif font-bold text-xs sm:text-sm tracking-wider uppercase flex items-center justify-center gap-2 transition-all shadow-[0_0_15px_rgba(245,158,11,0.25)] cursor-pointer"
                >
              ...
              <div className="bg-stone-950/80 border border-emerald-500/40 rounded-2xl p-5 sm:p-6 flex flex-col justify-between space-y-4">
                <div className="space-y-2.5">
                ...
                <button
                  ...
                  className="w-full py-3.5 px-4 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-serif font-bold text-xs sm:text-sm tracking-wider uppercase flex items-center justify-center gap-2 transition-all shadow-[0_0_15px_rgba(16,185,129,0.25)] cursor-pointer"
                >
                  {downloadSuccess ? (
                    <>
            ...
            {readings.length > 0 && (
              <div className="bg-stone-950/90 border border-stone-800 rounded-2xl p-5 sm:p-6 space-y-3">
                <div className="flex items-center justify-between">
                  <h4 className="text-xs sm:text-sm font-serif uppercase tracking-wider text-amber-300 font-bold flex items-center gap-2">
                ...
                <div className="space-y-2.5 max-h-48 overflow-y-auto pr-1">
                  {readings.slice(0, 5).map((r) => (
                    <div
                      key={r.id}
                      className="flex items-center justify-between p-3 rounded-xl bg-stone-900 border border-stone-800 hover:border-amber-500/40 transition-colors"
                    >
                      ...
                      <button
                        ...
                        className="px-3.5 py-2 rounded-lg bg-stone-800 hover:bg-amber-950/80 hover:border-amber-500/50 border border-stone-700 text-stone-200 hover:text-amber-200 text-xs sm:text-sm font-serif flex items-center gap-2 transition-colors shrink-0 ml-3 cursor-pointer"
            ...
            <div className="p-4 sm:p-5 rounded-2xl bg-amber-950/30 border border-amber-500/40 text-xs sm:text-sm font-serif text-amber-100 leading-relaxed flex items-start gap-3">
              <HelpCircle className="w-5 h-5 text-amber-400 shrink-0 mt-0.5" />
              <div>
                <strong className="text-amber-300 block mb-1 font-mono text-xs uppercase font-bold">
          ...
          <div className="pt-4 border-t border-stone-800 flex items-center justify-end relative z-10">
            <button
              onClick={onClose}
              className="px-6 py-2.5 rounded-xl bg-stone-800 hover:bg-stone-700 text-stone-100 text-sm font-serif font-semibold transition-colors cursor-pointer"
            >
              Close
            </button>
          </div>
